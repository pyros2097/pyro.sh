import { html, defineElement, string } from '../../web_modules/fuco.js';
...
const Slide = ({ title, subTitle, description, imgSrc, imgWidth }) => {
  console.log("props", { title, subTitle, description, imgSrc, imgWidth });
  return html`
    <div class="flex flex-col sm:flex-row w-full p-4 sm:p-8">
      ...
      <div
        class="flex-1 mt-8 sm:mt-0 sm:w-4/12 bg-white border-black border rounded-sm flex flex-col items-center justify-center">
        <div class="p-4">
...
defineElement('app-slide', Slide, propTypes);
