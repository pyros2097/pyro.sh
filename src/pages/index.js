    ...
    <main class="w-full h-full">
      <div class="w-full flex flex-1 flex-row justify-center">
        <div class="flex flex-row flex-1 items-center max-w-5xl text-lg font-source p-2 mt-4 sm:p-4">
          <div>
            <div>
              Hi there, I'm <strong>Peter John</strong>, a fullstack developer from Bangalore, India. I love writing code
              and I am lucky enough to do
              this as my job. I currently work for Equal Experts. I have a strong passion for golang but I also work with
              react and nodejs.
              <p>
                I like to work on open source and hobby projects. Over the course of 8 years I've accumlated a lot of useful
              ...
              <div class="pt-10">
                <ul class="flex flex-row mb-4">
                  ${slides.map((_, index) => {
                    ...
                    return (
                      html`
                        <li @click=${() => setItem(index)} class="px-3 py-1 cursor-pointer select-none ${classMap({ 'bg-black': selected, 'text-white': selected, 'hover:bg-gray-300': index !== item})}">
                        ${index+1}
                        </li>
                      `
                    )
              ...
              <div class="flex flex-1 flex-col">
                <div>
                  ...
                  <div class="mt-6 text-lg">
                    <div>Email: <a class="text-md text-newblue ml-1"
                        href="mailto:pyros2097@gmail.com">pyros2097@gmail.com</a></div>
                    <div class="mt-2">Github: <a class="text-md text-newblue ml-1"
                        href="https://github.com/pyros2097">pyros2097</a></div>
                    <div class="mt-2">LinkedIn: <a class="text-md text-newblue ml-1"
                        href="https://www.linkedin.com/in/pyros2097">pyros2097</a></div>
                  </div>
                </div>
              </div>
            </div>
